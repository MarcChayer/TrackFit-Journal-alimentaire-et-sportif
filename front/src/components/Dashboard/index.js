...
//               <FontAwesomeIcon icon={faCircle} color="#4b5c6b" />
//               <FontAwesomeIcon icon={faCarrot} inverse transform="shrink-6" />
//             </span>
//             <h3>Nutrition</h3>
//             <p>Tracker Nutrition</p>
//             <button className="trackers__button">
//               Ajouter
//             </button>
//           </li>
//           <li className="trackers__item">
//             <span className="fa-layers fa-fw fa-5x">
//               <FontAwesomeIcon icon={faCircle} color="#4b5c6b" />
//               <FontAwesomeIcon icon={faTint} inverse transform="shrink-6" />
//             </span>
//             <h3>Hydratation</h3>
...
//             <span className="fa-layers fa-fw fa-5x">
//               <FontAwesomeIcon icon={faCircle} color="#4b5c6b" />
//               <FontAwesomeIcon icon={faBed} inverse transform="shrink-6" />
//             </span>
//             <h3>Sommeil</h3>
//             <p>Tracker Sommeil</p>
//             <button className="trackers__button">
...
//             <span className="fa-layers fa-fw fa-5x">
//               <FontAwesomeIcon icon={faCircle} color="#4b5c6b" />
//               <FontAwesomeIcon icon={faRunning} inverse transform="shrink-6" />
//             </span>
//             <h3>Activité</h3>
//             <p>Tracker Activité sportive</p>
//             <button className="trackers__button">
//               Ajouter
//             </button>
//           </li>
...
//             <span className="fa-layers fa-fw fa-5x">
//               <FontAwesomeIcon icon={faCircle} color="#4b5c6b" />
//               <FontAwesomeIcon icon={faWeight} inverse transform="shrink-6" />
//             </span>
//             <h3>Poids</h3>
//             <p>Tracker Poids</p>
//             <button className="trackers__button">
