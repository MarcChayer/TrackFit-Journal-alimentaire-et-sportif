...
export default (store) => (next) => (action) => {
  ...
  switch (action.type) {
    case FETCH_SPORT_LIST:
      axios.get('http://107.23.126.240:8080/api/sportTypeList', { withCredentials: true })
        .then((res) => {
    ...
    case SET_TRACKER_SPORT:
      ...
      axios.post(`http://107.23.126.240:8080/api/dashboard/${userId}/sport`, action.payload,
    ...
    case SET_TRACKER_FOOD:
      ...
      axios.post(`http://107.23.126.240:8080/api/dashboard/${userId}/food`, action.payload,
        { withCredentials: true })
        .then((res) => {
    ...
    case FETCH_FOOD_LIST:
      // 52.91.105.182
      axios.get('http://107.23.126.240:8080/api/foodTypeList', { withCredentials: true })
        .then((res) => {
